DESCRIPTION - Welcome to SafeCity. Inside the file named "CODE" you will find all the code that is absolutely necessary to run the web app. 
...
INSTALLATION - to install our application please execute the following steps:
...
EXECUTION - To execute our application, follow the following steps:
